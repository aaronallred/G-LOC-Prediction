...
def main_loop(impute_type, n_neighbors, timestamp, model_type, method_key, baseline_window, window_size, stride, classifier_type):
    ...
    if classifier_type == 'all_hpo' or classifier_type == 'KNN_hpo':
        ...
        performance_metric_summary = single_classifier_performance_summary(accuracy_knn_hpo, precision_knn_hpo,
                                                                           recall_knn_hpo, f1_knn_hpo,
                                                                           specificity_knn_hpo, g_mean_knn_hpo)
