...
if __name__ == "__main__":
    ...
    feature_reduction_methods = ['target_mean', 'shuffle']
    ...
    save_file = 'Sequential_Optimization_Feature_Reduction_dictionary_model_type_' + str(model_type[1]) + '_reduced_baseline_remaining.pkl'
