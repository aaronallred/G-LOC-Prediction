...
def main_loop(impute_type, n_neighbors, timestamp, model_type, method_key, baseline_window, window_size, stride, classifier_type,
    ...
    if classifier_type == 'all_hpo' or classifier_type == 'EGB_hpo':
        ...
        performance_metric_summary = single_classifier_performance_summary(accuracy_gb_hpo, precision_gb_hpo,
                                                                           recall_gb_hpo, f1_gb_hpo,
                                                                           specificity_gb_hpo, g_mean_gb_hpo)
...
if __name__ == "__main__":
    ...
    baseline_windows_to_analyze = baseline_windows_to_analyze[0]

    current_baseline_window = baseline_windows_to_analyze
    ...
    save_file = 'Sequential_Optimization_Sliding_Window_dictionary_model_type_' + str(model_type[1]) + '_b1.pkl'
