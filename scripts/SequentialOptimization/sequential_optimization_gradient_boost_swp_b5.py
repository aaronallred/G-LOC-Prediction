...
if __name__ == "__main__":
    ...
    baseline_windows_to_analyze = baseline_windows_to_analyze[4]
    ...
    save_file = 'Sequential_Optimization_Sliding_Window_dictionary_model_type_' + str(model_type[1]) + '_b5.pkl'
