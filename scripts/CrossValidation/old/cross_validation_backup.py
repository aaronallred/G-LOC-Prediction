...
############################################# LOAD AND PROCESS DATA #############################################
    ...
    ### Impute missing row data
        ...
        features, indicator_matrix = faster_knn_impute(features, k=n_neighbors)
    ...
    # Training/Test Split
    x_train_NaN, x_test_NaN, y_train_NaN, y_test_NaN = stratified_kfold_split(y_gloc_labels,x_feature_matrix,
                                                              num_splits, kfold_ID)
    ...
    if impute_type == 3:
        ...
        x_train, indicator_matrix_train = faster_knn_impute(x_train_NaN, k=n_neighbors)

        # Impute Test Data
        x_test, indicator_matrix_test = faster_knn_impute(x_test_NaN, k=n_neighbors)
...
if __name__ == "__main__":
    ...
    runname = 'CrossValidationBackup-FasterImputer-SMOTECF_PCA_Explicit'
