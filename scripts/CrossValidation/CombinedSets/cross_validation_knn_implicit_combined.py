...
def main_loop(kfold_ID, num_splits, runname, y_gloc_labels, x_feature_matrix, random_state, all_features,
    ...
    if 'AFE_indicator_windowed' in selected_features:
        print("✅ AFE indicator was selected by Lasso.")
    else:
        print("❌ AFE indicator was NOT selected by Lasso.")
