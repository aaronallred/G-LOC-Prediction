...
def main_loop(impute_type, n_neighbors, timestamp, model_type, method_key, baseline_window, window_size, stride, classifier_type):
    ...
    if classifier_type == 'all_hpo' or classifier_type == 'SVM_hpo':
        ...
        performance_metric_summary = single_classifier_performance_summary(accuracy_svm_hpo, precision_svm_hpo,
                                                                           recall_svm_hpo, f1_svm_hpo,
                                                                           specificity_svm_hpo, g_mean_svm_hpo)
    ...
    if classifier_type == 'all' or classifier_type == 'SVM':
        ...
        performance_metric_summary = single_classifier_performance_summary(accuracy_svm, precision_svm, recall_svm, f1_svm, specificity_svm, g_mean_svm)
