...
def main_loop(x_train, x_test, y_train, y_test, random_state, class_weight_imb, classifier_type,
              imbalance_technique, timestamp, method_key, train_class, selected_features):
...
if __name__ == "__main__":
    ...
    for i in range(len(class_imbalance_methods)):
        ...
        main_loop(x_train.copy(), x_test.copy(), y_train.copy(), y_test.copy(), random_state, class_weight_imb,
                  classifier_to_use, current_class_imbalance_method, timestamp_outerloop, method_key_class_imbalance,
                  train_class, selected_features)
